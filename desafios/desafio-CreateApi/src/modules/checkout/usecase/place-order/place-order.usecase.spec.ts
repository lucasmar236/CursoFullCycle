...
describe("PlacerOrderUseCase unit test", ()=> {

    describe("validateProducts method", () => {
        //@ts-expect-error - no params in constructor
        const placeOrderUseCase = new PlaceOrderUseCase();

        it("should throw an error when products are selected", async () => {
            const input: PlaceOrderInputDto = { clientId : "", products : []}
    ...
    describe("execute method", () =>{
        ...
        it("should throw an error when products not found", async () => {
            ...
            const mockValidateProducts = jest
                ...
                //@ts-expect-error - not return bever
            ...
            const mockGetProduct = jest
                ...
                it("should not be approved",async () => {
                    ...
                    expect(output.products).toStrictEqual([
                        {id: "1", name:"Product 1",price: 10},{id: "2",name:"Product 2",price: 20},
                    ]);
                    ...
                    expect(mockCheckoutFacade.addOrder).toHaveBeenCalledTimes(1);
