...
describe('Invoice unit tests', () => {
    it("should create invoice",() => {
        ...
        expect(invoice.city).toEqual("testCity")
        expect(invoice.complement).toEqual("testComplement")
        expect(invoice.number).toEqual("123")
        expect(invoice.state).toEqual("testState")
        expect(invoice.street).toEqual("test")
        expect(invoice.zipCode).toEqual("testZipcode")
